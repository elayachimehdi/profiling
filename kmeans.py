...
#Les clusters 1 et 3 ont été mixés ensemble en post clustering (Voir fonction main) et en couleur pour plot
...
#    plt.show()
    ...
    Dataframe[['classe']] = Dataframe[['classe']].replace([0,1,2,3],['Risqué','Equilibré','Prudent','Equilibré'])
    Dataframe[['Score_classe']] = Dataframe[['Score_classe']].replace([0,1,2,3],['Risqué','Equilibré','Equilibré','Prudent'])
    return Dataframe
